appCtrl.controller('Map2Ctrl', function($scope, $ionicLoading, $compile, $http, $stateParams, Tasks, $window) {
    ...
    ionic.Platform.ready(function() {
      ...
      //           icon: ('https://maps.gstatic.com/mapfiles/ms2/micons/lightblue.png')
      //         });
      // >>>>>>> 759f13e22fa2b535066f5cd295b9608d9cc2f2e6
    });
  ...
  $scope.map = map; $scope.markers = [];
  var infoWindow = new google.maps.InfoWindow(); $scope.pickupMarker = function(info) {
  ...
  << << << < HEAD navigator.geolocation.getCurrentPosition(function(pos) {
    $scope.map.setCenter(new google.maps.LatLng(pos.coords.latitude, pos.coords.longitude));
    $scope.loading.hide();
  }, function(error) {
    alert('Unable to get location: ' + error.message);
...
}); >>> >>> > 759 f13e22fa2b535066f5cd295b9608d9cc2f2e6